  ...
  return $.fn.reportCard = function(options) {
    ...
    ReportCard = (function() {
      ...
      ReportCard.prototype.build = function(data) {
        ...
        html = "<p>I've passed " + data.badge_count + " lessons and scored " + (toThousands(data.points_total)) + " points on " + data.site + ".</p>\n<p>Here are some of my recently completed courses: </p>\n<ul class=\"badges\">";
